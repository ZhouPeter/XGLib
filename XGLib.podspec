#
#  Be sure to run `pod spec lint XGLib.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "Zhou" => "peterzhouningbo@gmail.com" }
  # Or just: spec.author    = "Zhou"
  # spec.authors            = { "Zhou" => "peterzhouningbo@gmail.com" }
  # spec.social_media_url   = "https://twitter.com/Zhou"
